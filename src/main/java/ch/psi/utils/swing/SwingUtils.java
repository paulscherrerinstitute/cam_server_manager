...
import static ch.psi.utils.swing.MainFrame.getDarculaLookAndFeel;
import static ch.psi.utils.swing.MainFrame.getLookAndFeel;
import static ch.psi.utils.swing.MainFrame.getNimbusLookAndFeel;
import static ch.psi.utils.swing.MainFrame.logger;
...
public class SwingUtils {
    ...
    public static void setLookAndFeel(String className) {
        ...
        if (Arr.containsEqual(Convert.toStringArray(MainFrame.LookAndFeelType.values()), className)){
            className = getLookAndFeel(MainFrame.LookAndFeelType.valueOf(className));
        }
        try {
